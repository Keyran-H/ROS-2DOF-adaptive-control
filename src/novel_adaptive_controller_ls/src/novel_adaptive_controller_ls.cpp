...
namespace novel_adaptive_controller_ls_ns
{
    class NovelAdaptiveControllerLS : public controller_interface::Controller<hardware_interface::EffortJointInterface>
    {
        ...
        void update(const ros::Time& time, const ros::Duration& period)
        {
            ...
            if (elapsed_time > 10.0) // Stop sending commands and dump data
            {
                ...
                if (!isDataDumped)
                {
                    dumpData(sim_states_debug, "/home/kiran/dissertation/ros_experimenting_ws/src/matlab_files/data/novel_adaptive_data_LS.csv");
    ...
    PLUGINLIB_EXPORT_CLASS(novel_adaptive_controller_ls_ns::NovelAdaptiveControllerLS, controller_interface::ControllerBase);
}
