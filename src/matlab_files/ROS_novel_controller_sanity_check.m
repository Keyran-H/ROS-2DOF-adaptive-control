clear
close all
sim_states = readtable("/home/kiran/dissertation/ros_experimenting_ws/src/matlab_files/data/novel_adaptive_data_paper.csv");
% sim_states = readtable("/home/kiran/dissertation/ros_experimenting_ws/src/matlab_files/data/novel_adaptive_data_paper_old.csv");
...
% theta1 = m1*l1^2 + m2*l1^2 + m2*l2^2 + Izz1 + Izz2
% theta2 = m2*l1*l2
% theta3 = m2*l2^2 + Izz2
% theta4 = m1*l1 + m2*l1
% theta5 = m2*l2
